...
import org.treant.scrollgrid2_mutiscreens.util.WeiboLoginActivity;
...
public class MainActivity extends Activity implements OnClickListener {
	...
	private ImageButton  btn1,btn2,btn3;private Bitmap bmp;
...
//				R.drawable.bora_french, 2000, Configure.screenHeight);
		bmp=Utils.getProperRunImageBitmap(getResources(), R.drawable.bora_french, 2000, Configure.screenHeight);
		runImage.setImageBitmap(bmp);
		curPage = (TextView) this.findViewById(R.id.cur_page);
		btn1=(ImageButton)findViewById(R.id.btn111);
		btn1.setOnClickListener(this);
		btn2=(ImageButton)findViewById(R.id.btn222);
		btn2.setOnClickListener(this);
		btn3=(ImageButton)findViewById(R.id.btn333);
...
//			finish();
	...
	protected void onDestroy() {
		...
		if(bmp!=null){
			if(!bmp.isRecycled()){
				bmp.recycle();Log.i("recyle", "recyle");
			}
