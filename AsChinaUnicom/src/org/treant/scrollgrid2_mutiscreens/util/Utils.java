...
//	}
	 ...
	 * @return
	 */
	public static Bitmap getProperRunImageBitmap(Resources res, int resId, int reqWidth, int reqHeight){
		final BitmapFactory.Options options=new BitmapFactory.Options();
		options.inJustDecodeBounds=true;
	...
	public static Bitmap getProperBitmap(Resources res, int resId, int reqWidth, int reqHeight){
		final BitmapFactory.Options options=new BitmapFactory.Options();
		options.inJustDecodeBounds=true;
		BitmapFactory.decodeResource(res, resId,options);
//		options.inSampleSize=getInSampleSize(options,reqWidth,reqHeight);
